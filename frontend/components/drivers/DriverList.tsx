        ...
        <tbody>
          {drivers.map((d) => (
            <tr key={d.id} className="border-b border-slate-100 last:border-0">
              <td className="py-2.5 text-slate-700">{d.component_name}</td>
              <td className="py-2.5 font-medium text-slate-900">{d.driver_name}</td>
              <td className="py-2.5 text-slate-500">{d.driver_category}</td>
