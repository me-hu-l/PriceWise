...
export const api = {
  ...
  getForecast: (id: number) => apiFetch<NotImplementedResponse>(`/api/materials/${id}/forecast`),
  getConfidence: (id: number) => apiFetch<NotImplementedResponse>(`/api/materials/${id}/confidence`),
